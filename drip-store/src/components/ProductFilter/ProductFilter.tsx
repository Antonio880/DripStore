...
const categoryItems = [
  { id: 'category1', name: 'category1', value: 'Category1', label: 'Esporte e lazer' },
  { id: 'category2', name: 'category2', value: 'Category2', label: 'Casual' },
  { id: 'category3', name: 'category3', value: 'Category3', label: 'Utilitário' },
...
const ProductFilter: React.FC = () => {
  return (
    <div className="bg-white md:shadow-lg p-4 rounded-lg w-64">
      ...
      <FilterSection title="Categoria" items={categoryItems} itemType="checkbox" />
